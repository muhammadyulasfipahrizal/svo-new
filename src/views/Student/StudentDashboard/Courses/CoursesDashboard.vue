...
<template>
  <div class="flex flex-column" style="gap: 10px">
    ...
    <!-- popular course -->
    <div class="flex flex-column" style="gap: 10px">
        <p class="text-xl font-bold">Popular course</p>
        <Carousel :value="popularCourses" :numVisible="4" :numScroll="1" class="carousel-width">
          <template #item="value">
    ...
    <!-- popular course -->
    <div class="flex flex-column" style="gap: 10px">
      <p class="text-xl font-bold">Free course</p>
